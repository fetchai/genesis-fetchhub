...
This document describe the steps needed in order to upgrade a validator node running on `fetchd v0.7.x` to the `fetchd 0.8.5`.
...
```bash
git clone --branch v0.8.5 https://github.com/fetchai/fetchd.git fetchd_0.8.5
cd fetchd_0.8.5
```
